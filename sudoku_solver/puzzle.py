...
def find_puzzle(image, debug=False):
    ...
    # check to see if we are visualizing each step of the image processing
    # pipeline (in this case, thresholding)
    if debug:
    ...
    # if the puzzle contour is empty then our script could not find the outline
    # of the sudoku puzzle so raise an error
...
def extract_digit(cell, debug=False):
    ...
    :return:
    """
    # apply automatic thresholding to the cell and then clear any connected
    ...
    # compute the percentage of masked pixels relative to the total area of the
    # image
